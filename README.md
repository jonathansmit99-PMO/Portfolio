...
- Proficient in **API integrations, Salesforce, Jira, Miro**, and enterprise platforms.
- AI-driven productivity and strategy (Certified: King’s College London, 2025).
- Deep experience in network redesign and core carrier infrastructure projects.

### **Leadership & Stakeholder Management**
- Strong track record influencing **C‑Suite and executive leadership**.
- Cross-functional orchestration with engineering, DevOps, UX, legal, and finance.
- Global ERP/enterprise project leadership across African universities and enterprises.

### **Problem Solving & Adaptability**
- Rapid solution design with broad business and technical insight.
- Agile product management combined with emerging AI methodologies.
- Focused on a long‑term path toward **Chief Product Officer (CPO)** or entrepreneurship.

---

## 🚀 Featured Projects & Impact

### **Digital Transformation & E-Commerce – EOH Network Solutions**
*Lead: End-to-end digital commerce platform integrating Salesforce + SAP.*

**Results:**  
- 40% faster client onboarding  
- 98% order fulfillment accuracy  
- 30% operational efficiency uplift  
- R24m annual expense reduction  
- Real-time sales dashboards + digital onboarding  
- Targeting 25% sales conversion uplift and 95% reduction in manual errors  

---

### **Core Infrastructure & Network Expansion – SEACOM**
*Built foundational infrastructure enabling exponential growth in 3 years.*
...
- Deployed 10-gig rings, SBCs, DDOS protection  
- Enabled scalable service delivery to 500+ clients  

---

### **ITS Software Upgrade – University of Limpopo**
...
### **Institutional Asset & Space Audit – Tshwane University of Technology**
*Large-scale physical audit across 100+ buildings.*
...
### **Large-Scale IT Transformation – Anglo American / HP**
*Migration of 4,500 users across 60+ mining sites.*
...
- Managed a R35m exposure with a 3rd-party vendor during COVID-19.  
- Ensured business continuity for 8 months under critical conditions.
